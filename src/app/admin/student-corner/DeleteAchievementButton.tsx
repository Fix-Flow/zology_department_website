...
import { deleteAchievement } from "@/actions/admin/student-corner";
...
export default function DeleteAchievementButton({ id }: { id: string }) {
  ...
  return (
    <button onClick={() => setConfirming(true)} className="p-1.5 text-red-500 hover:bg-red-50 rounded" title="Delete Achievement">
      <Trash2 size={16} />
    </button>
  );
}
