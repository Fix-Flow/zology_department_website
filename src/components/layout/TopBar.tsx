...
export default function TopBar() {
  return (
    <div className="bg-primary-dark text-white text-xs" style={{ height: "var(--topbar-height)" }}>
      <div className="section-container flex h-full items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Phone size={12} />
            <span className="hidden xs:inline">{CONTACT_PHONE_DISPLAY}</span>
          </a>
        ...
        {/* Right: Social Links + College Website */}
        <div className="flex items-center gap-3">
          <a
            href={COLLEGE_WEBSITE}
            target="_blank"
            rel="noopener noreferrer"
            className="text-white/70 hover:text-accent transition-colors hidden md:inline text-[11px]"
          >
            College Main Site →
          </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <SocialIcon href={SOCIAL_LINKS.youtube} label="YouTube">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </SocialIcon>
          </div>
        </div>
      </div>
