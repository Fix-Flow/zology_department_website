...
import { deleteDownload } from "@/actions/admin/downloads";
import toast from "react-hot-toast";
import { useRouter } from "next/navigation";


export default function DeleteDownloadButton({
  id,
  title,
}: {
  id: string;
  ...
  if (confirming) {
    return (
      <div data-component="DeleteDownloadButton" className="flex items-center gap-1">
        <button
