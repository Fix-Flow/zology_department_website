...
export default function DeleteGalleryImageButton({
  ...
  if (confirming) {
    return (
      <div data-component="DeleteGalleryImageButton" className="bg-white/90 backdrop-blur-sm p-1.5 rounded-lg flex items-center gap-1 shadow-sm">
        <button
  ...
  return (
    <button
      ...
      className="p-2 bg-white/90 backdrop-blur-sm hover:bg-red-50 text-red-500 rounded-lg transition-colors shadow-sm"
      title="Delete Image"
    >
      <Trash2 size={16} />
    </button>
