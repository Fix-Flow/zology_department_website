...
import { COLLEGE_NAME, CONTACT_EMAIL, CONTACT_PHONE, GOOGLE_MAPS_EMBED_URL } from "@/lib/constants";
            ...
            <div className="bg-neutral-bg border border-govt-border p-6 rounded-xl flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-govt-muted mt-1">
                  For official matters and collaborations, you may contact the HoD directly at <a href="mailto:ramesh.kumar@gdcsiddipet.ac.in" className="text-primary hover:underline">ramesh.kumar@gdcsiddipet.ac.in</a>
                </p>
              </div>
            </div>
          </div>
